...
`;function n(e){return e?new Date(e).toLocaleDateString("en-GB",{day:"numeric",month:"long",year:"numeric"}):"—"}function i(e){return e==null||e===""?"—":String(e)}function s(e){return i(e).replace(/\n/g,"<br/>")}function l(e){const o=e.sections.map((a,t)=>`<h2 class="sec"><span class="num">${t+1}.</span>${a.title}</h2>${a.inner}`).join("");return`
  <div class="page">
    ...
    <table class="idtable">
      <tr>
        <td class="lbl">Resident</td><td class="val">${i(e.residentName)}</td>
        ${e.extraIdCells||""}
      </tr>
    </table>
  ...
  `}function d(e,o){const a=`<!DOCTYPE html><html><head><meta charset="UTF-8"/><title>${e}</title><style>${r}</style></head><body>${o}</body></html>`,t=window.open("","_blank");return t?(t.document.write(a),t.document.close(),t.focus(),t.print(),!0):!1}export{l as b,n as f,s as n,d as o};
