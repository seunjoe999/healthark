...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  const Sidebar = () => (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-3 px-6 py-5 border-b border-white/10">
        ...
        <div>
          <h1 className="text-white font-bold text-lg leading-none">HealthArk</h1>
          <p className="text-blue-300 text-xs mt-0.5">Care Management</p>
        </div>
      </div>
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      <aside className="hidden lg:flex flex-col w-64 bg-navy-900 flex-shrink-0">
        <Sidebar />
      </aside>
      ...
      {sidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 bg-navy-900 flex flex-col z-10">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="lg:hidden bg-white border-b border-gray-100 px-4 py-3 flex items-center gap-3">
          ...
          <span className="font-bold text-navy-900">HealthArk</span>
        </header>
