  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-12 text-center">
        ...
        <p className="text-gray-500 text-sm">This module is being built — coming in the next phase</p>
      </div>
    </div>
  )
}
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/policies" element={<ProtectedRoute><ComingSoon title="Policies & Procedures" /></ProtectedRoute>} />
      <Route path="/ppe" element={<ProtectedRoute><ComingSoon title="PPE Stock" /></ProtectedRoute>} />
      <Route path="/messages" element={<ProtectedRoute><ComingSoon title="Messages" /></ProtectedRoute>} />
      <Route path="/alerts" element={<ProtectedRoute><ComingSoon title="Alerts" /></ProtectedRoute>} />
