...
async function ensureColumns() {
  const stmts = [
    ...
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS created_by UUID`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS su_location TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS incident_location TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS incident_time TIME`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS witnesses TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS medical_required BOOLEAN DEFAULT FALSE`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS medical_details TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS injury_details TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS immediate_actions TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS decisions_breached TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS lessons_learnt TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS outside_agency BOOLEAN DEFAULT FALSE`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS agency_details TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS management_recs TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS prevention_actions TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS reported_to TEXT`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS reported_at TIMESTAMPTZ`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS manager_ack_by UUID`,
    `ALTER TABLE safeguarding_concerns ADD COLUMN IF NOT EXISTS manager_ack_at TIMESTAMPTZ`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS staff_id UUID REFERENCES staff(id)`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS conducted_by UUID REFERENCES staff(id)`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS home_id UUID REFERENCES homes(id)`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS assessment_type TEXT`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS custom_name TEXT`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS outcome TEXT`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS recommendations TEXT`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS next_due_date DATE`,
    `ALTER TABLE assessments ADD COLUMN IF NOT EXISTS document_url TEXT`,
...
async function bootstrap() {
  ...
  // ONE-TIME: emergency password reset for admin@compcarehub.co.uk (locked out, no other admin account available)
  try {
    const { pool: dbPool } = await import('./config/database');
